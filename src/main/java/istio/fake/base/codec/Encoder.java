 ...
 * <h3>Form encoding</h3>
 * <p>
 * If any parameters are found in {@link fake.MethodMetadata#formParams()}, they will be collected
...
public interface Encoder {
   ...
   * @throws FakeException when encoding failed due to a checked exception.
   */
  void encode(Object object, Type bodyType, RequestTemplate template) throws FakeException;
